...
const CreateEmployee = () => {
    ...
    const handleNotifyEmployee = async () => {
        ...
        try {
            ...
            if (response.ok) {
                toast.success(
                    "Notification sent & employee initiated successfully!",
                    { theme: "dark" },
                );
                ...
                toast.error(result.message || "Failed to notify employee", {
                    theme: "dark",
                });
            }
        } catch (err) {
        ...
        <>
            ...
            <div className="min-h-screen bg-[#171717] px-4 pt-8 pb-10">
                <div className="max-w-2xl mx-auto bg-[#EDEDED] shadow rounded-lg p-6">
                    <h2 className="text-2xl font-semibold mb-6 text-center text-[#E4002B]">
                    ...
                    <div className="mb-6">
                        ...
                        <div className="flex justify-center gap-4 flex-wrap">
                            ...
                            >
                                <span
                                    className={`font-semibold ${workerType === "Permanent" ? "text-[#E4002B]" : "text-gray-700"}`}
                                >
                                    Permanent
                                </span>
                            ...
                            >
                                <span
                                    className={`font-semibold ${workerType === "Contractual" ? "text-[#E4002B]" : "text-gray-700"}`}
                                >
                                    Contractual
                                </span>
                                <span className="text-xs text-gray-500 mt-1">
