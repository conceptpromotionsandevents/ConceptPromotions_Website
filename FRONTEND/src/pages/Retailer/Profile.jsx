...
const FileInput = ({
    ...
    function handleFileChange(e) {
        ...
        const newPreview = f.type.startsWith("image/")
...
const RetailerProfile = () => {
    ...
    // Send OTP Handler
    // Send OTP Handler - Only for primary contact
    const handleSendOtp = async (phoneType) => {
        if (phoneType !== "contact") return; // Only allow primary contact verification
    ...
    // Verify OTP Handler - Only for primary contact
    ...
    useEffect(() => {
        const fetchProfile = async () => {
            try {
                ...
                setExistingRegistrationForm(
                    data.registrationFormFile?.url || null,
                );
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            formData.append("phoneVerified", contactVerified);

            // Files - only append if new files selected
            if (govtIdPhoto?.raw)
                formData.append("govtIdPhoto", govtIdPhoto.raw);
            if (personPhoto?.raw)
                formData.append("personPhoto", personPhoto.raw);
            if (registrationFormFile?.raw)
                formData.append(
                    "registrationFormFile",
                    registrationFormFile.raw,
                );
            if (outletPhoto?.raw)
                formData.append("outletPhoto", outletPhoto.raw);
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <button
                                        ...
                                        className={`absolute right-2 top-1/2 -translate-y-1/2 text-xs font-semibold px-2 py-1 rounded transition ${
                                            contactVerified
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className={`w-full pl-10 px-4 py-2 border rounded-lg outline-none focus:ring-2 ${
                                                gstError
                        ...
                        <section className="space-y-4">
                            ...
                            <div className="mt-2 flex items-start gap-2">
                                <input
                                    ...
                                    checked={pennyCheck}
                                    onChange={(e) =>
                                        setPennyCheck(e.target.checked)
                                    }
                                ...
                                <label className="text-sm text-gray-700 leading-5">
                                    I confirm that I have received the ₹1
                                    verification amount in my bank account.
                                    {pennyCheckLocked && (
                        ...
                        <section className="space-y-4">
                            <div>
                                ...
                                <p className="text-[11px] text-gray-500 mt-1">
                                    <span className="text-red-500">*</span>{" "}
                                    Accepted formats: PNG, JPG, JPEG, PDF, DOC —
                                    less than 1 MB
                                </p>
                            </div>
                        ...
                        <div className="mt-8 p-6 bg-gray-50 border-2 border-gray-200 rounded-lg">
                                ...
                                pennyCheck ? (
                                    ...
                                    <div className="flex items-center gap-2 bg-red-50 border border-red-500 rounded-lg px-4 py-3">
                                        ...
                                        <span className="text-red-700 font-medium">
                                            KYC Not Verified - Complete Required
                                            Fields
                                        </span>
                                    </div>
                                )}
                            ...
                            <div className="space-y-2">
                                ...
                                <ul className="space-y-1 text-sm">
                                    <li
                                        className={`flex items-center gap-2 ${panCard ? "text-green-600" : "text-red-600"}`}
                                    >
                                        {panCard ? "✓" : "✗"} PAN Card Number
                                    </li>
                                    <li
                                        className={`flex items-center gap-2 ${govtIdType ? "text-green-600" : "text-red-600"}`}
                                    >
                                        {govtIdType ? "✓" : "✗"} Government ID
                                        Type
                                    </li>
                                    <li
                                        className={`flex items-center gap-2 ${govtIdNumber ? "text-green-600" : "text-red-600"}`}
                                    >
                                        {govtIdNumber ? "✓" : "✗"} Government ID
                                        Number
                                    </li>
                                    <li
                                        className={`flex items-center gap-2 ${govtIdPhoto || existingGovtIdPhoto ? "text-green-600" : "text-red-600"}`}
                                    >
                                        {govtIdPhoto || existingGovtIdPhoto
                                            ? "✓"
                                            : "✗"}{" "}
                                    ...
                                    <li
                                        className={`flex items-center gap-2 ${bankName ? "text-green-600" : "text-red-600"}`}
                                    >
                                        {bankName ? "✓" : "✗"} Bank Name
                                    </li>
                                    <li
                                        className={`flex items-center gap-2 ${accountNumber ? "text-green-600" : "text-red-600"}`}
                                    >
                                        {accountNumber ? "✓" : "✗"} Account
                                        Number
                                    </li>
                                    <li
                                        className={`flex items-center gap-2 ${ifsc ? "text-green-600" : "text-red-600"}`}
                                    >
                                        {ifsc ? "✓" : "✗"} IFSC Code
                                    </li>
                                    <li
                                        className={`flex items-center gap-2 ${branchName ? "text-green-600" : "text-red-600"}`}
                                    >
                                        {branchName ? "✓" : "✗"} Branch Name
                                    </li>
                                    <li
                                        className={`flex items-center gap-2 ${pennyCheck ? "text-green-600" : "text-red-600"}`}
                                    >
                                        {pennyCheck ? "✓" : "✗"} Penny Transfer
                                        Verification
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="bg-gray-900 text-gray-200 rounded-lg shadow-2xl w-[90%] md:w-[600px] relative p-6 border border-red-700 max-h-[80vh] overflow-y-auto scrollbar-thin scrollbar-thumb-red-600 scrollbar-track-gray-800 scrollbar-thumb-rounded-full">
                                ...
                                <div className="text-xs text-gray-300 space-y-2 leading-relaxed text-justify">
                                    <p>
                                        ...
                                        ("Notice") will inform you about how the
                                        CPE proposes to collect, handle, store,
                                        use, disclose and transfer ("Process")
                                        your personal data.
                                    </p>
                                    ...
                                    <ol className="list-[lower-alpha] ml-4 space-y-1">
                                        <li>
                                            Identity and/or contact information
                                            and other details for you or your
                                            outlet such as name, physical
                                            address, mobile number, email
                                            address, signatures, date of birth,
                                            copy of identity and residence
                                            identifiers such as Aadhaar or other
                                            officially valid documents,
                                            Permanent Account Number, passport,
                                            biometric information, marital
                                            status, citizenship, residential
                                            status etc.
                                        </li>
                                        <li>
                                            Financial or related information
                                            such as income details, account
                                            statements, passbooks, employment or
                                            occupational information,
                                            information collected when you
                                            undertake transactions including
                                            when you send or receive payments,
                                            etc.
                                        </li>
                                        <li>
                                            Information that you provide about
                                            others such as nominee details,
                                            family details, associate details,
                                            employer details, authorized
                                            signatories and other authorized
                                            representatives in case of
                                            non-individual applicants, etc.
                                        </li>
                                        <li>
                                            Information that others provide
                                            about you such as data obtained from
                                            other parties who are involved in
                                            transactions undertaken by you, from
                                            any persons / organisations involved
                                            in any payment system or
                                            infrastructure or architecture of
                                            which we are a part and whether your
                                            interface/ interaction is directly
                                            with us or indirectly through such
                                            third parties, etc.
                                        </li>
                                        <li>
                                            Information from and about your
                                            online activities such as your
                                            location, IP address, device and
                                            operating system, unique identifiers
                                            such as International Mobile
                                            Equipment Identity (IMEI) number,
                                            technical usage data, contact lists,
                                            fingerprint (if you choose to enable
                                            it), passwords or PINs in encrypted
                                            form, etc.
                                        </li>
                                        <li>
                                            Information such as records of our
                                            correspondence with you, your
                                            interaction with CPE including
                                            chats, emails, telephone
                                            conversations, grievances, etc.
                                        </li>
                                    </ol>
                                    ...
                                    <ol className="list-[lower-alpha] ml-4 space-y-1">
                                        <li>
                                            To meet our legal, regulatory or
                                            compliance obligations such as
                                            customer due diligence, know your
                                            customer/ anti-money laundering
                                            checks, undertaking data protection
                                            impact assessments, data audits,
                                            etc.
                                        </li>
                                        <li>
                                            To assess and monitor your continued
                                            eligibility and suitability for the
                                            Requested Product such as your KYC
                                            status, risk assessment, including
                                            by way of background checks,
                                            inspections, verifications, etc.
                                        </li>
                                        <li>
                                            To provide you with and enable your
                                            use of the Requested Product.
                                        </li>
                                        <li>
                                            To initiate legal or regulatory
                                            proceedings for enforcement of our
                                            rights or defending your claims.
                                        </li>
                                        <li>
                                            To provide you with customer service
                                            and to communicate with you through
                                            emails, chats, telephone calls and
                                            other means.
                                        </li>
                                        <li>
                                            To take actions necessary for
                                            prevention and detection of crime
                                            and fraud, portfolio sensitivity
                                            analysis, etc.
                                        </li>
                                    </ol>
                                    <p className="text-gray-400 text-[11px]">
                                        Note: We may undertake the
                                        abovementioned activities either
                                        ourselves or through our affiliates or
                                        third parties such as vendors, service
                                        providers, other regulated entities such
                                        as credit information companies and KYC
                                        registration and authentication service
                                        agencies, etc., in accordance with our
                                        internal policies and applicable law.
                                    </p>

                                    <p>
                                        <strong>3. Data Sharing:</strong> We may
                                        share your personal data with our
                                        affiliates or third parties such as
                                        credit information companies, bureaus,
                                        switches, networks, agencies, vendors,
                                        card association, settlement, transfer
                                        and processing intermediaries, payment
                                        aggregators, payment gateways, payments
                                        systems, service providers, consultants,
                                        vendors, agents, fintech entities,
                                        co-brand entities / partners,
                                        distributors, selling/ marketing agents,
                                        any partners, collaborators, co-lenders,
                                        co-originators, merchants, aggregators,
                                        lead generators, sourcing entities,
                                        clients, customers or other persons with
                                        whom we have any direct or indirect
                                        arrangement or tie-up or contract for
                                        any products or services, any TPAPs, or
                                        other players/ intermediaries in any
                                        ecosystem of which the CPE is a part,
                                        with entities managing loyalty
                                        programmes, managing, generating and/or
                                        implementing any offers, discounts,
                                        cashbacks, chargebacks, features, etc.,
                                        and such entities may share your
                                        personal data with their service
                                        providers, consultants, vendors, etc.,
                                        for the purposes mentioned in this
                                        Notice. In certain cases, these
                                        entities, which receive your personal
                                        data from us may also be legally
                                        required to give you a notice regarding
                                        their Processing of your personal data
                                        and request for your consent before they
                                        Process the same. We encourage you to
                                        read their privacy notices and contact
                                    ...
                                    <p>
                                        ...
                                        consent at any time by following the
                                        process provided under the 'Consent
                                        Withdrawal' section of the Privacy
                                        Policy. <br></br>
                                        Please note that our Processing of your
                                        personal data before you withdraw your
                                        consent will not be impacted. You should
                                        also be aware that if you withdraw your
                                        consent for us to Process your personal
                                        data for some of the purposes we have
                                        mentioned in this Notice, we may not be
                                        able to continue offering you the
                                        Requested Product. This could mean that
                                        the terms and conditions applicable to
                                        discontinuation or closure of your
                                        Requested Product will become
                                        applicable.
                                        <br></br>
                                        We encourage you to review the terms and
                                        conditions applicable to the Requested
                                        Product to understand the consequences
                                        of withdrawal of your consent in respect
                                        of use of your personal data.
                                    </p>

                                    <p>
                                        <strong>5. Grievances:</strong> If you
                                        believe that you have any concerns
                                        regarding how we Process your personal
                                        data, you have the right to let us know
                                        your grievances. Please contact us at
                                        the details provided under 'Contact
                                        Information' below to register your
                                        concerns.
                                    </p>
                                    <p className="text-gray-400 text-[11px]">
                                    ...
                                    <p>
                                        <strong>6. Consent Declaration:</strong>{" "}
                                        By providing your consent by ticking the
                                        checkbox, you acknowledge and agree to
                                        the following:
                                    </p>
                                    <ol className="list-[lower-alpha] ml-4 space-y-1">
                                        <li>
                                            That you have read and understood
                                            the contents of this Notice and
                                            consent to the Processing of your
                                            personal data as described here.
                                        </li>
                                        <li>
                                            That you give your consent
                                            voluntarily, without any coercion or
                                            influence from the CPE or any other
                                            person.
                                        </li>
                                        <li>
                                            That you will provide and ensure
                                            that the CPE maintains accurate,
                                            updated, complete and consistent
                                            personal data.
                                        </li>
                                        <li>
                                            The CPE may Process your personal
                                            data for certain other purposes
                                            without your consent, where the law
                                            allows us to do so such as
                                            enforcement of a legal claim against
                                            you or for the CPE to make
